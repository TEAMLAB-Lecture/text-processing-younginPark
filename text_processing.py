...
def no_vowels(input_string):
    ...
    for i in range(len(input_string)):
        if input_string[i] == 'a' or input_string[i] == 'A' or input_string[i] == 'e' or input_string[i] == 'E' \
        or input_string[i] == 'i' or input_string[i] == 'I' or input_string[i] == 'o' or input_string[i] == 'O' \
        or input_string[i] == 'u' or input_string[i] == 'U':
            continue
        else:
